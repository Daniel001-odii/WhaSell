<template>
   <!--   <RouterLink :to="`/shops/${name}`">
    ...
    <RouterLink :to="`/shops/${name}`" class="flex flex-1 min-w-[300px] relative h-[290px] bg-gray-50 rounded-lg flex-col overflow-hidden">
        ...
        <div class=" h-[30%] w-full p-8">
            ...
            <p class=" text-gray-200 text-sm">{{ location }}</p>
        </div>
    </RouterLink>
</template>
