  ...
  <footer class=" bg-white pt-24 border-t p-6">
    ...
    <div class="flex flex-row flex-wrap justify-between container mx-auto gap-6 py-6">
      ...
      <div class="flex flex-col gap-3 w-full md:w-[35%]">
        ...
        <!-- WhatsApp Channel -->
        <div class="mt-6">
          <h3 class="font-semibold text-gray-800">Join Our WhatsApp Channel</h3>
          <p class="text-gray-600">Access, stay up to date and grow with WhatSell</p>
          <div class="flex items-center mt-2 border border-gray-300 rounded-lg overflow-hidden">
            <input type="text" class="p-2 w-full outline-none" value="https://whatsapp.com/channel/0029vae6..." readonly>
            <button class="p-2 bg-gray-200 hover:bg-gray-300">
