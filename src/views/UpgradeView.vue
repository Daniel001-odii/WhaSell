        ...
        <div class="border rounded-lg flex flex-col gap-3 p-3  px-8 mt-1 bg-white">
            ...
            <form @submit.prevent="buyCoinsNow" class="flex flex-row py-4 mt-3 items-center text-lg gap-5">
                <div class="flex flex-row items-center">
                    ...
                    <input type="number" v-model="coins_input" @keyup="variablePaymentAmount(coins_input)" @change="variablePaymentAmount(coins_input)" class=" border-b-2 p-3 outline-none" placeholder="Enter of number of coins"/>
                </div>
